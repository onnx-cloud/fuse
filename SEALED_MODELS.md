...
1. Graph fingerprint
   ...
   - Include: op names, op types, attribute key/value pairs, fn inputs/outputs, and stable metadata required to reinstantiate the graph deterministically.
...
1. Canonical graph serialization
   ...
   - Serialize using a simple and stable compact format (e.g., newline-delimited fn records with escaping or stable JSON with sorted keys and deterministic numeric formatting).
