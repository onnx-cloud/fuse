...
# Runner assumes ONNX model already exists at onnx/cookbook/elliptic_envelope.onnx
model_path = Path("onnx/cookbook/elliptic_envelope.onnx")
...
sample = np.array([2.0, 0.0], dtype=np.float32)
try:
