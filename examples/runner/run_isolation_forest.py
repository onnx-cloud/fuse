...
# Runner assumes ONNX model already exists at onnx/cookbook/isolation_forest.onnx
model_path = Path("onnx/cookbook/isolation_forest.onnx")
...
sample = np.array([0.5, 1.0, 1.5], dtype=np.float32)
try:
